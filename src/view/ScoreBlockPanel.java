...
public class ScoreBlockPanel extends JPanel {
  ...
  private static final int DIMENSION_OF_SCORE_X = 64;
  ...
  private static final int DIMENSION_OF_LEVEL_Y = 191;
  
  /** The integer used for the y value of the dimension of the lines label on the board. */
  private static final int DIMENSION_OF_LINES_Y = 129;
  ...
  private static final int SCORE2_BOX_HEIGHT = 40;
  ...
  private void createScoreLabels() {
    ...
    final JLabel label3 = new JLabel("Lines:");
    ...
    label3.setFont(new Font(ARIAL, Font.BOLD, SCORE_FONT_SIZE));
